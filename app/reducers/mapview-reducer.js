...
const types = {
  ...
  MAPVIEW_SHOW_ME_AND_TARGET_FIND_USER: 'MAPVIEW_SHOW_ME_AND_TARGET_FIND_USER',
  MAPVIEW_SHOW_ME_AND_TARGET_FIND_USER_ERROR: 'MAPVIEW_SHOW_ME_AND_TARGET_FIND_USER_ERROR',
};
...
const mapViewReducer = (state = initialState, action) => {
  ...
  switch (type) {
    ...
    case types.MAPVIEW_SHOW_ME_AND_TARGET_FIND_USER:
    ...
    case types.MAPVIEW_SHOW_ME_AND_TARGET_FIND_USER_ERROR:
